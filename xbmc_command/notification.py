...
class Command(core.Command):
  ...
  def call(self, args):
    ...
    self.xbmc.GUI.ShowNotification({'title':args.title, 'message':args.message,
  ...
  def create_parser(self, parser):
    ...
    parser.add_argument('--title', dest='title', metavar='<title>',
        ...
        help='the title of the notification, default \'xbmc-command\'')
    ...
    parser.add_argument('--time', dest='displaytime', default=5000,
        ...
        help='the time in milliseconds the notification will be visible')
