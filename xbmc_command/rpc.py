...
class Command(core.Command):
  ...
  def create_parser(self, parser):
    ...
    parser.add_argument('method', metavar='<method>',
        help='the RPC method name. Namespace and Method name seperated with a "dot" (.).')

    parser.add_argument('params', metavar='<params>', nargs='?', default='{}',
        help='the parameters. Encoded as JSON object. Defaults to {} if omitted')

    parser.add_argument('--id', dest='id', metavar='<request id>',
        help='the id of the request. Defaults to the given method name')
