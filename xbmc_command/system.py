...
class Command(core.Command):
    ...
    def create_parser(self, parser):
        ...
        parser.epilog += "  quit       Quit the XBMC Mediacenter application\n"
        parser.epilog += "  shutdown   Shutdown the system\n"
        parser.epilog += "  reboot     Reboot the system\n"
        parser.epilog += "  suspend    Suspend the system\n"
        parser.epilog += "  hibernate  Hibernate the system\n"
        parser.epilog += "  infos      Print XBMC system info labels\n"

        parser.add_argument('command', metavar='<command>',
                            choices=[
                                'quit', 'shutdown', 'reboot',
                                'suspend', 'hibernate', 'infos'
                            ],
